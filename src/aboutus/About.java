...
public class About extends JFrame {
	...
	public About() {
		...
		JLabel lblPayrollManagementSystem = new JLabel("HR Management System");
		...
		JLabel lblPayrollSystem = new JLabel("HR System");
		...
		JLabel lblVimoxSShah = new JLabel("Vaishali Pabreja");
		...
		JLabel lblVmokshshahhotmailcom = new JLabel("vaishalipabreja05@gmail.com");
		...
		JLabel label = new JLabel("Copyright2017 \u00a9, All rights reserved.");
